...
class ControladorTest {
    ...
    void crearCliente() throws Exception {
        Controlador controlador = new Controlador();
        assertEquals(true, controlador.crearCliente("70", "jose3@gamil.com", "mayor 3 Valencia", "45678934D", '1'));
    }
    ...
    void crearCEbd() throws Exception {
        Cliente_Estandar cE = new Cliente_Estandar("julian", "Los Palos, 167. 08756", "536543D", "julian3@gmail.com");
    ...
    void crearCPbd() throws Exception {
        Cliente_Premium cP = new Cliente_Premium(0.10, "gianfran", "Los Palos, 300. 08756", "131233D", "gianfranco3@gmail.com");
    ...
    void crearpedido() throws Exception {
        ...
        Articulo a = new Articulo("A", "Ejemplo de descripción de producto ", 4, 3, 10);
        Pedido p = new Pedido(cE, a, 13, 1, 18.2);
